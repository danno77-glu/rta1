/*
  # Create auditor statistics function

  1. New Functions
    - `get_auditor_stats()` - Returns statistics for all auditors including:
      - Completed audits (past scheduled audits)
      - Booked audits (future scheduled audits) 
      - Outstanding audits (overdue customers without scheduled audits)
